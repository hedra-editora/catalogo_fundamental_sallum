...
\fancyhf{}
\fancyhead[RE]{Catálogo \hspace{2cm}}
...
\fancyhead[LO]{\rule[-1ex]{0pt}{1ex}  \hspace{2cm} Catálogo}
\fancyfoot[C]{}
}
...
\setlength{\headsep}{1cm}
\fancyhf{}
\fancyhead[L]{\rule[-1ex]{0pt}{1ex} \hspace{2cm} \textbf{Catálogo 2021}}
\fancyfoot[C]{}
}
...
\setlength{\headsep}{1cm}
\fancyhf{}
\fancyhead[RE]{\rule[-1ex]{0pt}{1ex} Catálogo \hspace{2cm}}
...
\setlength{\headsep}{1cm}
\fancyhf{}
\fancyhead[R]{\rule[-1ex]{0pt}{1ex} Catálogo \hspace{2cm}}
